...
###################################################
### code chunk number 43: SparseEx1
###################################################
...
###################################################
### code chunk number 44: SparseEx1Run
###################################################
...
###################################################
### code chunk number 45: SparseEx1Run2
###################################################
...
###################################################
### code chunk number 46: SparseEx1RunHeatmap
###################################################
heatmap(sapres, ssim)


###################################################
### code chunk number 47: LoadCh22Promoters
###################################################
data(ch22Promoters)
...
###################################################
### code chunk number 48: SimCh22Promoters
###################################################
library(kernlab)
...
###################################################
### code chunk number 49: APCh22Promoters
###################################################
...
###################################################
### code chunk number 50: HeatMapAPCh22Promoters
###################################################
heatmap(promAP, promSim, Rowv=FALSE, Colv=FALSE)


###################################################
### code chunk number 51: aggExCh22Promoters
###################################################
promAgg <- aggExCluster(promSim, promAP)


###################################################
### code chunk number 52: DendrogramAPCh22Promoters
###################################################
plot(promAgg)


###################################################
### code chunk number 53: ExtractAggCh22Promoters
###################################################
...
###################################################
### code chunk number 54: HeatMap5Ch22Promoters
###################################################
heatmap(prom5, promSim, Rowv=FALSE, Colv=FALSE)


###################################################
### code chunk number 55: NegDistMatDataSet2
###################################################
s <- negDistMat(x2)


###################################################
### code chunk number 56: CreateToyData
###################################################
...
###################################################
### code chunk number 57: NegEuclDistMatToyData
###################################################
negDistMat(ex)


###################################################
### code chunk number 58: NegSqEuclDistMatToyData
###################################################
negDistMat(ex, r=2)


###################################################
### code chunk number 59: NegMaxDistToyData
###################################################
negDistMat(ex, method="maximum")


###################################################
### code chunk number 60: NegManhattanDistToyData
###################################################
negDistMat(ex, method="manhattan")


###################################################
### code chunk number 61: NegCanberraDistToyData
###################################################
negDistMat(ex, method="canberra")


###################################################
### code chunk number 62: NegMinkowskiDistToyData
###################################################
negDistMat(ex, method="minkowski", p=3)


###################################################
### code chunk number 63: GetFunction
###################################################
sim <- negDistMat(r=2)
is.function(sim)
apcluster(sim, x1)
...
###################################################
### code chunk number 64: RBFKernelToyData
###################################################
expSimMat(ex)


###################################################
### code chunk number 65: LaplaceKernelToyData
###################################################
expSimMat(ex, r=1)


###################################################
### code chunk number 66: PearsonToyData
###################################################
corSimMat(ex, method="pearson")


###################################################
### code chunk number 67: SpearmanToyData
###################################################
corSimMat(ex, method="spearman")


###################################################
### code chunk number 68: TruncDistToyData
###################################################
linSimMat(ex, w=1.2)


###################################################
### code chunk number 69: LinKernelToyData
###################################################
linKernel(ex[2:5,])


###################################################
### code chunk number 70: NormLinKernelToyData
###################################################
linKernel(ex[2:5,], normalize=TRUE)


###################################################
### code chunk number 71: RectangularNegDistMatDataSet1
###################################################
...
###################################################
### code chunk number 72: SimFunCh22Promoters
###################################################
...
###################################################
### code chunk number 73: APCh22Promoters
###################################################
...
###################################################
### code chunk number 74: CustomSimSparse
###################################################
...
###################################################
### code chunk number 75: CreateLabeledToyData
###################################################
x3 <- c(1, 2, 3, 7, 8, 9)
...
###################################################
### code chunk number 76: ShowToyDataLabels
###################################################
s3
colnames(s3)
...
###################################################
### code chunk number 77: ClusterLabeledToyData
###################################################
...
###################################################
### code chunk number 78: ExtractLabelsFromClusterToyData
###################################################
apres3a@exemplars
...
###################################################
### code chunk number 79: HeatmapResultAPClusterDataSetq08b
###################################################
...
###################################################
### code chunk number 80: HeatmapResultAPClusterDataSet2q08c
###################################################
...
###################################################
### code chunk number 81: PlotAddLegend
###################################################
plot(apres2a, x2)
...
###################################################
### code chunk number 82: PlotOnlyLegend
###################################################
plot.new()
...
###################################################
### code chunk number 83: GetBibTeX (eval = FALSE)
###################################################
