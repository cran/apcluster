...
recommended to use the function \verb+apclusterLM()+
(``LM'' $=$ \underline{L}ess
...
Further notes:
\begin{itemize}
\item The function \verb+apcluster()+ makes use of matrix and vector
operations. If your \R\ system has been configured to parallelize such
operations internally, \verb+apcluster()+ will automatically benefit
...
\newblock {\em Bioinformatics}, 27:2463--2464, 2011.
