...
\begin{center}
<<HeatmapResultAPClusterDataSet1b,fig=TRUE,echo=TRUE,width=5,height=5>>=
heatmap(apres1b, s1)
@
\end{center}
...
\begin{center}
<<IrisDataPlot1,fig=TRUE,echo=TRUE,width=10,height=10>>=
plot(apIris1, iris)
@
\end{center}
...
\setkeys{Gin}{width=0.55\textwidth}
\begin{center}
<<IrisDataHeatmap1,fig=TRUE,echo=TRUE,width=5,height=5>>=
heatmap(apIris1)
@
\end{center}
...
\setkeys{Gin}{width=\textwidth}
\begin{center}
<<IrisDataPlot,fig=TRUE,echo=TRUE,width=10,height=10>>=
plot(apIris2, iris)
@
\end{center}
...
\setkeys{Gin}{width=0.55\textwidth}
\begin{center}
<<IrisDataHeatmap2,fig=TRUE,echo=TRUE,width=5,height=5>>=
heatmap(apIris2)
@
\end{center}
...
therein):
\begin{center}
<<DendrogramAggExAPDataSet2b,fig=TRUE,echo=TRUE,width=5,height=5>>=
...
\setkeys{Gin}{width=0.55\textwidth}
\begin{center}
<<APClusterLevDataSet3,fig=TRUE,echo=TRUE,width=5,height=5>>=
...
\setkeys{Gin}{width=0.55\textwidth}
\begin{center}
<<APClusterLevDataSet3Heat,fig=TRUE,echo=TRUE,width=5,height=5>>=
heatmap(apres3)
@
\end{center}
...
\begin{center}
<<SparseEx1Run,fig=TRUE,echo=TRUE,width=5,height=5>>=
...
\begin{center}
<<SparseEx1RunHeatmap,fig=TRUE,echo=TRUE,width=5,height=5>>=
heatmap(sapres, ssim)
@
\end{center}
...
\begin{center}
<<HeatmapResultAPClusterDataSetq08b,fig=TRUE,echo=TRUE,width=5,height=5>>=
...
\begin{center}
<<HeatmapResultAPClusterDataSet2q08c,fig=TRUE,echo=TRUE,width=5,height=5>>=
...
\item[Version 1.3.0:] \hfill
  ...
  \item correction of exemplars returned by \verb+apcluster+ for
