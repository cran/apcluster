...
Users who upgrade to Version 1.3.3 or 1.3.4 from an older version should be
aware that the package now requires Rcpp Version 0.11.0 or 0.11.1 (or newer).
